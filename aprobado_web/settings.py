...
FINANCIACION_EDUCATIVA_CONTINUATION_REMINDER_1_HOURS = int(
    os.environ.get('FINANCIACION_EDUCATIVA_CONTINUATION_REMINDER_1_HOURS', '1')
)
FINANCIACION_EDUCATIVA_CONTINUATION_REMINDER_2_HOURS = int(
    os.environ.get('FINANCIACION_EDUCATIVA_CONTINUATION_REMINDER_2_HOURS', '6')
)
FINANCIACION_EDUCATIVA_CONTINUATION_REMINDER_3_HOURS = int(
    os.environ.get('FINANCIACION_EDUCATIVA_CONTINUATION_REMINDER_3_HOURS', '24')
)
FINANCIACION_EDUCATIVA_CONTINUATION_REMINDER_FINAL_HOURS = int(
    os.environ.get('FINANCIACION_EDUCATIVA_CONTINUATION_REMINDER_FINAL_HOURS', '48')
)
FINANCIACION_EDUCATIVA_CONTINUATION_MAX_MESSAGES = int(
    os.environ.get('FINANCIACION_EDUCATIVA_CONTINUATION_MAX_MESSAGES', '4')
)
FINANCIACION_EDUCATIVA_CONTINUATION_REMINDER_BATCH_SIZE = int(
    os.environ.get('FINANCIACION_EDUCATIVA_CONTINUATION_REMINDER_BATCH_SIZE', '100')
)
